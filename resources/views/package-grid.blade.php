...
<html class="no-js" lang="en">
    ...
    @if(Session::has('flash_message'))
        <div class="col-md-6 offset-md-3 alert-box alert-success" style="position: relative; margin-bottom: 3px;">
            <strong class="col-md-6 offset-md-3"> {!! session('flash_message') !!}</strong>
        </div>
     @endif
        <!--[if lte IE 9]>
                                ...
                                <div class="row">
                                    ...
                                    <div class="single-package mb-50">
                                        <div class="package-img">
                                            <img src="\Tours\Image\{{$value->Image}}" width="100" height="240" alt="package image">
                                            <div class="package-cost">{{$value->Budget}}</div>
                                        </div>
                                        <h5>
                                            <span>{{$value->name}}</span>
                                            <i style="float: right" onclick="myFunction({{$value->CompanyId}})" class="fa fa-thumbs-up"></i>
                                        </h5>

                                        <p>{{$value->days}}</p>

                                        <a data-modal="modal{{$value->id}}" class="bt">READ MORE
                                        ...
                                        <div id="modal{{$value->id}}" class="modal">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body" style="text-align: center";>
                                                    <p><img src="\Tours\Image\{{$value->Image}}" width="500" height="200" alt=""></p>
                                                    <p><b>Days: </b>{{$value->days}}</p>
                                                    <p><b>Departure date: </b>{{$value->departure}}</p>
                                                    <p><b>Budget: </b>{{$value->Budget}}</p>
                                                ...
                                                <div style="align-items: normal" class="modal-footer">
                                                    @foreach($data1 as $value1)
                                                        @if($value1->company_id==$value->CompanyId)
                                                                    <?php
                                                                    $Like=$Like+$value1->value;
                                                                    ?>
                                                        @endif
        ...
        <section class="promote-area gray-bg pt-110 pb-120">
            <div class="container">
                <div class="promote-content text-center">
                    <h2>GET DISCOUNT 10-20% OFF ANY TOUR PACKAGE</h2>
