...
<body id="body-top">
    <div id="app">
        ...
        <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
          ...
          <a href="index-2"><img src="<?php echo e(asset('img/logo/logo.png')); ?>" alt="logo"></a>
            ...
            <div class="row wrapper"  style="min-height: calc(100vh - 50px);">
                <aside class="col-12 col-sm-3 p-0 bg-dark">
                    <nav class="navbar navbar-expand-sm navbar-dark bg-dark align-items-start flex-sm-column flex-row">
                        <a class="navbar-brand" href="http://localhost:8000/company">
                        ...
                        <div class="collapse navbar-collapse" id="navbarResponsive">
                            <ul class="flex-column navbar-nav w-100 justify-content-between mr-auto">
                                <li class="nav-item">
                                    <a class="nav-link px-0 text-truncate" href="http://localhost:8000/Booking" data-parent="#navbar1" data-toggle="tooltip" data-target="#m0" aria-expanded="false">
                                        <i class="fas fa-object-group fa-fw"></i> <span class="">Booking</span>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse" id="m1">
                                        <ul class="flex-column nav">                                    
                                            <a class="nav-link px-0 text-truncate" href="http://localhost:8000/Tour/create">Add Tours</a>
                                            <a class="nav-link px-0 text-truncate" href="http://localhost:8000/Tour">View Tours</a>
                                        </ul>
                                    </div>
                                </li>
                            </ul>
