    ...
    <?php endif; ?>
            <div class="container">
                <div class="promote-content text-center">
                    <h2>Add <span>Tour For </span>Bidding</h2>
                
                </div>
                <br><br><br>
                <br>
                <div class="row">
                <form method="post" action="/addutour">
                ...
                <div class="form-group row">
                    ...
                    <label for="lgFormGroupInput" class="col-md-2 col-form-label  col-form-label-lg">Booked Seats</label>
                    <div class="col-md-10">
