			...
			<div class="row milestones_container">
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						...
						<div class="milestone_counter" data-end-value="09">0</div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						...
						<div class="milestone_text">Valleys visited</div>
					</div>
				</div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						...
						<div class="milestone_counter" data-end-value="1323">0</div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						...
						<div class="milestone_text">Festivals Covered</div>
					</div>
				</div>
			...
			<div class="row icon_box_container">
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						...
						<div class="icon_box_title">Hotel Reseration</div>
						<p class="icon_box_text">////////.....</p>
						<a href="#" class="icon_box_more">Read More</a>
					</div>
				</div>
						...
						<div class="footer_latest_content">
							...
							<div class="footer_latest_item">
								...
								<div class="footer_latest_item_content">
									<div class="footer_latest_item_title"><a href="news.html">Blossom Hunza</a></div>
									<div class="footer_latest_item_date">Jan 09, 2019</div>
								</div>
							</div>
							...
							<div class="footer_latest_item">
								...
								<div class="footer_latest_item_content">
									...
									<div class="footer_latest_item_date">Nov 09, 2018</div>
								</div>
							</div>
