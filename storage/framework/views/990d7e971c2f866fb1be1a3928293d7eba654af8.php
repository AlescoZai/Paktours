					...
					<div class="items item_grid clearfix">
						...
						<div class="item clearfix rating_5">
							...
							<div class="item_content">
								<div class="item_price">From Rs10000</div>
								<div class="item_title">Naran </div>
								<ul>
									<li>1 person</li>
									<li>4 nights</li>
									<li>3 star hotel</li>
						...
						<div class="item clearfix rating_3">
							...
							<div class="item_content">
								<div class="item_price">From Rs12000</div>
								<div class="item_title">Kashmir</div>
								<ul>
									<li>1 person</li>
									<li>4 nights</li>
									<li>3 star hotel</li>
						...
						<div class="item clearfix rating_4">
							...
							<div class="item_content">
								<div class="item_price">From RS9000</div>
								<div class="item_title">Swat</div>
								<ul>
									<li>1 person</li>
									<li>4 nights</li>
									<li>3 star hotel</li>
						...
						<div class="item clearfix rating_5">
							...
							<div class="item_content">
								<div class="item_price">From Rs10000</div>
								<div class="item_title">Chitral</div>
								<ul>
									<li>1 person</li>
									<li>4 nights</li>
									<li>3 star hotel</li>
						...
						<div class="footer_latest_content">
							...
							<div class="footer_latest_item">
								...
								<div class="footer_latest_item_content">
									<div class="footer_latest_item_title"><a href="news.html">Camping Deosai</a></div>
