                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-8">
                            <div class="call-to-action">
                                ...
                                +9999587801 (Sunday - Friday : 9:00am - 5:00pm)
                            </div>
                        </div>
                                    ...
                                    <ul class="select-bar">
                                        <li class="location clearfix">
                                            <select name="location" class="location-here">
                                                ...
                                                <option value="Rajshahi">MURREE</option>
                                                <option value="Chitagong">SWAT</option>
                                                <option value="SKhulna">NARAN-KHAGAN</option>
                                            </select>
                                        </li>
                                        <li class="location clearfix">
                                            <select name="location" class="location-here member">
                                                ...
                                                <option value="Rajshahi">MURREE</option>
                                                <option value="Chitagong">SWAT</option>
                                                <option value="SKhulna">NARAN-KAGHAN</option>
                                            </select>
                                        </li>
                                        <li class="location clearfix">
                            ...
                            <div class="tab-pane fade" id="home" role="tabpanel" aria-labelledby="home-tab"><div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="single-package mb-50">
                                        ...
                                        <h5>
                                            <span>Gilgit</span> - 5 Days, 4 Nights</h5>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="single-package mb-50">
                                        ...
                                        <h5>
                                            <span>Naran</span> - 4 Days, 3 Nights</h5>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in
                                            some form, by injected.</p>
                                        <a class="read-more" href="#">READ MORE
                                            <i class="icofont icofont-arrow-right"></i>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="single-package mb-50">
                                        ...
                                        <h5>
                                            <span>Khagan</span> - 3 Days, 2 Nights</h5>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in
                                            some form, by injected.</p>
                                        <a class="read-more" href="#">READ MORE
                                            <i class="icofont icofont-arrow-right"></i>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="single-package mb-50">
                                        ...
                                        <h5>
                                            <span>Swat</span> - 5 Days, 4 Nights</h5>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in
                                            some form, by injected.</p>
                                        <a class="read-more" href="#">READ MORE
                                            <i class="icofont icofont-arrow-right"></i>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="single-package mb-50">
                                        ...
                                        <h5>
                                            <span>Khunjerab</span> - 4 Days, 3 Nights</h5>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in
                                            some form, by injected.</p>
                                        <a class="read-more" href="#">READ MORE
                                            <i class="icofont icofont-arrow-right"></i>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="single-package mb-50">
                                        ...
                                        <h5>
                                            <span>Neelum valley</span> - 3 Days, 2 Nights</h5>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in
                                            some form, by injected.</p>
                                        <a class="read-more" href="#">READ MORE
                                            <i class="icofont icofont-arrow-right"></i>
                            ...
                            <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <div class="single-package p-list mb-50">
                                    ...
                                    <div class="pack-content">
                                        <div class="p-cost">Rs.3000</div>
                                        <h5>
                                            <span>Natiya gali</span> - 5 Days, 4 Nights</h5>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some</p>
                                        <a class="read-more p-list" href="#">READ MORE
                                            <i class="icofont icofont-arrow-right"></i>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="single-package p-list mb-50">
                                    ...
                                    <div class="pack-content">
                                        <div class="p-cost">Rs.3000</div>
                                        <h5>
                                            <span>Sakardu</span> - 5 Days, 4 Nights</h5>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some</p>
                                        <a class="read-more p-list" href="#">READ MORE
                                            <i class="icofont icofont-arrow-right"></i>
                                        </a>
                                ...
                                <div class="single-package p-list mb-50">
                                    ...
                                    <div class="pack-content">
                                        <div class="p-cost">Rs.3000</div>
                                        <h5>
                                            <span>Urak valley</span> - 5 Days, 4 Nights</h5>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some</p>
                                        <a class="read-more p-list" href="#">READ MORE
                                            <i class="icofont icofont-arrow-right"></i>
                                        </a>
                                ...
                                <div class="single-package p-list mb-50">
                                    ...
                                    <div class="pack-content">
                                        <div class="p-cost">Rs.3000</div>
                                        <h5>
                                            <span>Bargot valley</span> - 5 Days, 4 Nights</h5>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some</p>
                                        <a class="read-more p-list" href="#">READ MORE
                                            <i class="icofont icofont-arrow-right"></i>
                                        </a>
                                ...
                                <div class="single-package p-list mb-50">
                                    ...
                                    <div class="pack-content">
                                        <div class="p-cost">Rs3000</div>
                                        <h5>
                                            <span>Rupal valley</span> - 5 Days, 4 Nights</h5>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some</p>
                                        <a class="read-more p-list" href="#">READ MORE
                                            <i class="icofont icofont-arrow-right"></i>
                                        </a>
