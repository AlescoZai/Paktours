                        ...
                        <div class="comments-wrap mb-100">
                            ...
                            <ul class="comment-list">
                                <li>
                                    ...
                                    <ul class="comment-child">
                                        <li>
                                            <div class="comment">
                                                <div class="commentor-thumb f-left">
                                                    <img src="img/blog/comment2.jpg" alt="comment-img">
                                                </div>
                                                <div class="comment-content">
                                                    <h6><a href="#">Shahmeer</a></h6>
                                                    <div class="comment-time">
                                                        20 January, 2016
                                                    </div>
                                ...
                                <li>
                                    <div class="comment">
                                        <div class="commentor-thumb f-left">
                                            <img src="img/blog/comment3.jpg" alt="comment-img">
                                        </div>
                                        <div class="comment-content">
                                            <h6><a href="#">Rida</a></h6>
                                            <div class="comment-time">
                                ...
                                <form action="#">
                                    <div class="row">
                                        <div class="col-lg-6 mb-30">
                                            <input class="comment-field" type="text" placeholder="Your Name">
                                        </div>
                                        <div class="col-lg-6 mb-30">
                                            <input class="comment-field" type="email" placeholder="Your Email">
                                        </div>
                                        <div class="col-lg-12 ">
                                            <textarea class="comment-field" placeholder="Your Message here......."></textarea>
                                        </div>
                                        <div class="col-12">
