...
<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <ol class="breadcrumb">
      ...
      <div class="container">
        <div >
          <center> <a href="Company/create" class="btn btn-danger"> <i class="fa fa-plus" aria-hidden="true"></i></a>
          </center>
        </div>
        <br>
        <table class="table table-striped">
          ...
          <?php $__currentLoopData = $tour; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td> <img src="/Tour/Image/<?php echo e($post['Image']); ?>" width="250" height="250"> </td>
              <td><a href="<?php echo e(action('CompanyController@edit', $post['id'])); ?>" class="btn btn-warning">Edit</a></td>
              <td>
                <form action="<?php echo e(action('CompanyController@destroy', $post['id'])); ?>" method="post">
