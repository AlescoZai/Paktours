...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="content-header-background-container background-parallax"><img class="background-parallax-item" src="images/header-1.jpg" data-src="images/header-1.jpg" alt=""/></div>
        <div class="content-header-background-overlay"> </div>
                            ...
                            <div class="contact-field">
                                <form id="ajax-contact" action="mail.php" method="post">
                                        ...
                                        <div class="col-lg-6 col-md-6 text-center" >
                                            <div class="single-contact-field1">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="single-contact-field1">
                                                <input type="password"  name="password" class="text-field" id="password" placeholder="Password" required>
                                            </div>
                                        </div>
            ...
            <div class="partners-block">
                <div class="container">
                    <div class="block-heading1">
                        <h2><u></u>Our <b>Partners</b></u></h2>
                        <p>tag line</p>
                    </div>
                    <div class="row">
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="partners-block-image"> <img src="partners-1.jpg" alt=""></div>
                        </div>
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="partners-block-image"> <img src="partners-2.jpg" alt=""></div>
                        </div>
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="partners-block-image"> <img src="partners-3.jpg" alt=""></div>
                        </div>
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="partners-block-image"> <img src="partners-4.jpg" alt=""></div>
                        </div>
                    </div>
                </div>
            </div>
