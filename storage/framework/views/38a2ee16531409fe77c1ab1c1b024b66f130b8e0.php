    ...
    <section class="slider-area ">
        ...
        <div class="slider-wrapper">
            <div class="slider-large-active">
                <div class="single-slider home-2" style="background: url(<?php echo e(asset('/img/bg/about-breadcrumb.jpg')); ?>);" data-overlay="6">
            ...
            <div class="row">
                ...
                <div class="slider-search-form">
                    <div>
                        <h2 class="text-center" style="color: white">User Dashboard</h2>
