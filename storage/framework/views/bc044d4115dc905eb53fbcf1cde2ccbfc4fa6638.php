        ...
        <div class="container">
            ...
            <form method="post" action="<?php echo e(url('User')); ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="number" class="form-control" id="lgFormGroupInput" placeholder="title" name="phone">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" id="lgFormGroupInput" placeholder="title" name="password">
                    </div>
                </div>
