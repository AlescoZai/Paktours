                    ...
                    <nav class="navbar navbar-expand-sm navbar-dark bg-dark align-items-start flex-sm-column flex-row">
                        ...
                        <div class="collapse navbar-collapse" id="navbarResponsive">
                            <ul class="flex-column navbar-nav w-100 justify-content-between mr-auto">
                                <li class="nav-item">
                                    <a class="nav-link px-0 text-truncate" href="index-2" data-parent="#navbar1" data-toggle="tooltip" data-target="#m0" aria-expanded="false">
                                        <i class="fas fa-home fa-fw"></i> <span class="">Home</span>
                                    </a>
                                </li>
