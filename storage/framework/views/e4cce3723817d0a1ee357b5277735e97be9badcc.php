...
<div class="super_container">
	...
	<div class="home">
		<div class="home_background" style="background-image:url(images/Backgroundimageskardu.jpg)"></div>
		<div class="home_content">
			<div class="home_content_inner">
				<div class="home_text_large">Discover</div>
				<div class="home_text_small">Your Way To Go</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="row top_content">
				...
				<div class="col-lg-3 col-md-6 top_col">
					...
					<div class="top_item">
						<a href="#">
							<div class="top_item_image"><img src="images/Naran-valley1.jpg" alt="https://unsplash.com/@sgabriel"></div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 last_col">
					<div class="last_item">
						<div class="last_item_content">
							<div class="last_subtitle">Skardu</div>
							<div class="last_percent">20%</div>
							<div class="last_title">Last Minute Offer</div>
							<div class="last_text">A great place to join In cold desert skardu.</div>
				...
				<div class="col-lg-6 last_col">
					<div class="last_item">
						<div class="last_item_content">
							<div class="last_subtitle">Fairy Meadows</div>
							<div class="last_percent">10%</div>
							<div class="last_title">Last Minute Offer</div>
							<div class="last_text">A great trip for you and your beloved ones</div>
							<div class="button last_button"><a href="offers.html">See Offer</a></div>
						</div>
					</div>
				</div>
	...
	<div class="video_section d-flex flex-column align-items-center justify-content-center">
		...
		<div class="video_content">
			<div class="video_title">A day on Shandur</div>
			<div class="video_subtitle">A trip organized by WayToGo team</div>
					...
					<div class="popular_content d-flex flex-md-row flex-column flex-wrap align-items-md-center align-items-start justify-content-md-between justify-content-start">
						...
						<div class="popular_item">
							<a href="offers.html">
								...
								<div class="popular_item_content">
									<div class="popular_item_price">From Rs6000</div>
									<div class="popular_item_title">Neelum Valley</div>
								</div>
							</a>	
						</div>
						...
						<div class="popular_item">
							<a href="offers.html">
								...
								<div class="popular_item_content">
									<div class="popular_item_price">From Rs12000</div>
									<div class="popular_item_title">Sharda</div>
								</div>
							</a>	
						</div>
						...
						<div class="popular_item">
							<a href="offers.html">
								...
								<div class="popular_item_content">
									<div class="popular_item_price">From Rs15000</div>
									<div class="popular_item_title">Deosai Plains</div>
								</div>
							</a>	
						</div>
						...
						<div class="popular_item">
							<a href="offers.html">
								...
								<div class="popular_item_content">
									<div class="popular_item_price">From Rs9000</div>
									<div class="popular_item_title">Ushu forest</div>
								</div>
							</a>
						</div>
						...
						<div class="popular_item">
							<a href="offers.html">
								...
								<div class="popular_item_content">
									<div class="popular_item_price">From Rs7000</div>
									<div class="popular_item_title">Kumrat Valley</div>
								</div>
							</a>
						</div>
						...
						<div class="popular_item">
							<a href="offers.html">
								...
								<div class="popular_item_content">
									<div class="popular_item_price">From Rs10000</div>
									<div class="popular_item_title">Chitral</div>
								</div>
							</a>
						</div>
						...
						<div class="popular_item">
							<a href="offers.html">
								...
								<div class="popular_item_content">
									<div class="popular_item_price">From Rs12000</div>
									<div class="popular_item_title">Kalash Festival</div>
								</div>
							</a>	
						</div>
						...
						<div class="popular_item">
							<a href="offers.html">
								...
								<div class="popular_item_content">
									<div class="popular_item_price">From Rs13000</div>
									<div class="popular_item_title">Khunjrab pass</div>
								</div>
							</a>
						</div>
		...
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title text-center">
						<h2>Tours Company</h2>
						<div>Take a look at our Partners</div>
					</div>
				</div>
			</div>
		</div>
		<div class="special_content">
			<div class="special_slider_container">
                ...
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					...
					<div class="owl-item">
						<div class="special_item">
							<div class="special_item_background"><img src="\TravelAgencies\Image\<?php echo e($value->Image); ?>" alt=""></div>
							<div class="special_item_content text-center">
								<div class="special_category">Visiting</div>
								<div class="special_title"><a href="offers"><?php echo e($value->CompanyName); ?></a></div>
							</div>
						</div>
					</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 footer_col">
					<div class="footer_about">
						...
						<div class="footer_about_text">Your way to Go.</div>
						>
					</div>
				</div>
						...
						<div class="footer_latest_content">
							...
							<div class="footer_latest_item">
								...
								<div class="footer_latest_item_content">
									<div class="footer_latest_item_title"><a href="news.html">Ushu forest</a></div>
									<div class="footer_latest_item_date">Oct 09, 2018</div>
								</div>
							</div>
