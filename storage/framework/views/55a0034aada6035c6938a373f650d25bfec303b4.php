...
<html class="no-js" lang="en">
    ...
    <?php if(Session::has('flash_message')): ?>
        <div class="col-md-6 offset-md-3 alert-box alert-success" style="position: relative; margin-bottom: 3px;">
            <strong class="col-md-6 offset-md-3"> <?php echo session('flash_message'); ?></strong>
        </div>
     <?php endif; ?>
        <!--[if lte IE 9]>
                                ...
                                <div class="row">
                                    ...
                                    <div class="single-package mb-50">
                                        ...
                                        <h5>
                                            ...
                                            <i style="float: right" onclick="myFunction(<?php echo e($value->CompanyId); ?>)" class="fa fa-thumbs-up"></i>
                                        </h5>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div style="align-items: normal" class="modal-footer">
                                                    <?php $__currentLoopData = $data1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($value1->company_id==$value->CompanyId): ?>
                                                                    <?php
